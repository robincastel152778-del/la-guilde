...
(function () {
  ...
  function preview(it){
    ...
    if (it.cat === 'bordures' && it.fichier)
      return `<div class="ge-pv ge-pv-frm"><span class="ge-av">🎮</span>`+
    ...
    if (it.cat === 'couleurs')
      return `<div class="ge-pv ge-pv-txt"><span class="ge-nom ge-c-${it.id}">Pierric</span></div>`;
    if (it.cat === 'statuts')
  ...
  function itemCard(it, ctx){
    ...
    return `<div class="ge-card" style="border-color:${col}55">
      ${preview(it)}
      <div class="ge-meta">
  ...
  async function openShop(){
    ...
    if (!ov){
      ...
      document.getElementById('ge-body').addEventListener('click', e => {
